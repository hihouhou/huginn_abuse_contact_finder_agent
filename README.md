...
```ruby
huginn_abuse_contact_finder_agent
# when only using this agent gem it should look like this:
ADDITIONAL_GEMS=huginn_abuse_contact_finder_agent
```
...
1. Fork it ( https://github.com/[my-github-username]/huginn_abuse_contact_finder_agent/fork )
